...
<div class="inner_content_info_agileits">
    <div class="container">
        <div class="tittle_head_w3ls">
            <h3 class="tittle three">Connectez-vous </h3>
        </div>
                ...
                <div class="login-form-rec">
                    <form action="{{ route('login') }}" method="post">
                        ...
                        <input type="email" name="email"class="@error('email') is-invalid @enderror" placeholder="E-mail" autocomplete="email" autofocus>
                                ...
                                @enderror
                        <input type="password" name="password" placeholder="Password" class="@error('email') is-invalid @enderror"autocomplete="current-password" autofocus>
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong class="text-danger">{{ $message }}</strong>
                                    </span>
